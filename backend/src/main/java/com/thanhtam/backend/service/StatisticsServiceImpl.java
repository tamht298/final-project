...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public Double getChangeExamUser() {
        ...
        List<ExamUser> examUsers = examUserRepository.findByIsFinishedIsTrueOrderByTimeFinishDesc();
    ...
    public Double getChangeAccount() {
        ...
        if(countAccountNow==0 && countAccoutLastWeek==0){
            return 0.00;
        }
        if(countAccountNow==0 && countAccoutLastWeek!=0){
            return countAccoutLastWeek*-100.00;
        }
        if(countAccountNow!=0 && countAccoutLastWeek==0){
            return countAccountNow*100.00;
        }
        Double result = (double) countAccountNow - countAccoutLastWeek;
        result = DoubleRounder.round(result / countAccoutLastWeek, 2);
